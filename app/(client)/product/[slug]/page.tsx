      ...
      <div>
        <h2 className="text-3xl md:text-4xl font-bold mb-2">
          ...
          <p className="bg-green-100 w-24 text-center text-green-600 text-sm py-2.5 font-semibold rounded-lg">
            ...
            <p className="text-sm text-gray-600 tracking-wide pointer-events-none">
              {product?.description}
              </p>
              <div className="flex items-center gap-2.5 lg:gap-5">
                ...
                />
                <button className="border-2 border-darkColor/30 text-darkColor/60
                px-2.5 py-1.5 rounded-md hover:text-darkColor hover:border-darkColor hoverEffect">
