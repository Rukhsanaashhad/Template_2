  ...
  return (
    <Container className='py-10'>
      ...
      <div className='flex flex-col items-center justify-center py-5 md:py-10 px-4'>
        <FileX className="h-24 w-24 text-teal-600 mb-4" />
        <Title className=''>No Orders Found</Title>
        <p className="mt-2 text-sm text-gray-600 text-center max-w-md ">It looks like you haven&apos;t placed any orders yet. Start Purchasing to see your orders here!</p>
